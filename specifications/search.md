...
Our goal is to evolve VasútTérkép from a real-time map into a comprehensive railway information hub. These new features will empower users to not only see where trains *are*, but to find the trains they *need* and understand station activity at a glance.
