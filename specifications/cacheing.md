## Specification: High-Concurrency Architecture for VonatterKep

### 1. Vision & Core Principle

**Objective:** To re-architect the VonatterKep application to handle 5,000+ concurrent users reliably by decoupling the user-facing API from the external MÁV API.
