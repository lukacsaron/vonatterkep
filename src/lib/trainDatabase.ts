...
export const HUNGARIAN_TRAIN_TYPES: Record<string, TrainType> = {
  ...
  "0431": {
    ...
    category: TrainCategory.LOCOMOTIVE,
    propulsion: PropulsionType.ELECTRIC,
    hasAirConditioning: false,
    comfortLevel: ComfortLevel.BASIC,
    reliabilityRating: 3,
    maxSpeed: 160,
    yearIntroduced: 1963,
    modernized: 2010,
  ...
  "0470": {
    ...
    comfortLevel: ComfortLevel.MODERN,
    reliabilityRating: 5,
    maxSpeed: 200,
    yearIntroduced: 1996,
  ...
  "0471": {
    ...
    propulsion: PropulsionType.ELECTRIC,
    hasAirConditioning: true,
    comfortLevel: ComfortLevel.PREMIUM,
    reliabilityRating: 5,
    maxSpeed: 200,
    yearIntroduced: 2012,
  ...
  "0288": { uicCode: "0288", name: "M28", fullName: "M28 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.VINTAGE, reliabilityRating: 2, maxSpeed: 100, yearIntroduced: 1958, features: ["Historic locomotive"], operationalNotes: "Rare, mostly heritage services" },
  "0319": { uicCode: "0319", name: "M31", fullName: "M31 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 100, yearIntroduced: 1960, features: ["Branch line services"], operationalNotes: "Used on non-electrified lines" },
  "0408": { uicCode: "0408", name: "M40", fullName: "M40 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 120, yearIntroduced: 1963, features: ["Medium power"], operationalNotes: "Regional and freight services" },
  "0418": { uicCode: "0418", name: "M41", fullName: "M41 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 120, yearIntroduced: 1963, features: ["Reliable workhorse"], operationalNotes: "Common on non-electrified lines" },
  "0438": { uicCode: "0438", name: "M43", fullName: "M43 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 120, yearIntroduced: 1968, features: ["Upgraded M41"], operationalNotes: "Improved version of M41" },
  "0448": { uicCode: "0448", name: "M44", fullName: "M44 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.STANDARD, reliabilityRating: 4, maxSpeed: 120, yearIntroduced: 1973, features: ["More powerful"], operationalNotes: "Higher power diesel locomotive" },
  "0478": { uicCode: "0478", name: "M47", fullName: "M47 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.STANDARD, reliabilityRating: 4, maxSpeed: 140, yearIntroduced: 1975, modernized: 2000, features: ["High power", "Passenger services"], operationalNotes: "Most powerful Hungarian diesel, IC services" },
  "0618": { uicCode: "0618", name: "M61", fullName: "M61 diesel locomotive", manufacturer: "Nohab", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.VINTAGE, reliabilityRating: 3, maxSpeed: 120, yearIntroduced: 1963, features: ["Swedish design"], operationalNotes: "Distinctive Swedish-designed locomotive" },
  "0628": { uicCode: "0628", name: "M62", fullName: "M62 diesel locomotive", manufacturer: "Voroshilovgrad", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 100, yearIntroduced: 1965, features: ["Soviet design"], operationalNotes: "Soviet-era locomotive, freight focused" },
  "0638": { uicCode: "0638", name: "M63", fullName: "M63 diesel locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 120, yearIntroduced: 1975, features: ["Branch line specialist"], operationalNotes: "Light diesel for branch lines" },
  ...
  // Other EMUs
  "1425": { uicCode: "1425", name: "Talent", fullName: "Bombardier Talent electric multiple unit", manufacturer: "Bombardier", category: TrainCategory.EMU, propulsion: PropulsionType.ELECTRIC, hasAirConditioning: true, comfortLevel: ComfortLevel.MODERN, reliabilityRating: 4, maxSpeed: 160, yearIntroduced: 2006, features: ["Tilting technology", "Comfortable seating"], operationalNotes: "Tilting EMU for faster regional services" },
  "1426": { uicCode: "1426", name: "Desiro", fullName: "Siemens Desiro electric multiple unit", manufacturer: "Siemens", category: TrainCategory.EMU, propulsion: PropulsionType.ELECTRIC, hasAirConditioning: true, comfortLevel: ComfortLevel.MODERN, reliabilityRating: 4, maxSpeed: 160, yearIntroduced: 2008, features: ["Reliable operation", "Good comfort"], operationalNotes: "Workhorse EMU for regional services" },
  ...
  "0117": {
    ...
    manufacturer: "Ganz-MÁVAG",
    category: TrainCategory.RAILCAR,
  ...
  "0127": { uicCode: "0127", name: "Bzmot IP", fullName: "Bzmot IP diesel railcar", manufacturer: "Ganz-MÁVAG", category: TrainCategory.RAILCAR, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.STANDARD, reliabilityRating: 3, maxSpeed: 80, yearIntroduced: 1990, modernized: 2010, features: ["Improved version", "Better comfort"], operationalNotes: "Modernized Bzmot variant" },
  "1136": { uicCode: "1136", name: "Bzmot Iker", fullName: "Bzmot twin-unit diesel railcar", manufacturer: "Ganz-MÁVAG", category: TrainCategory.DMU, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.STANDARD, reliabilityRating: 3, maxSpeed: 80, yearIntroduced: 1985, features: ["Twin unit", "Higher capacity"], operationalNotes: "Two-unit Bzmot for higher capacity" },

  // Special DMUs
  "1446": { uicCode: "1446", name: "Jenbacher", fullName: "Jenbacher J3998 diesel multiple unit", manufacturer: "Jenbacher", category: TrainCategory.DMU, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 80, yearIntroduced: 1960, features: ["Austrian design"], operationalNotes: "GYSEV operation, cross-border services" },

  // Motor coaches
  "0414": { uicCode: "0414", name: "BDVmot", fullName: "BDVmot motor coach", manufacturer: "Ganz-MÁVAG", category: TrainCategory.RAILCAR, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 80, yearIntroduced: 1970, features: ["Motor coach"], operationalNotes: "Passenger/baggage motor coach" },
  "0424": { uicCode: "0424", name: "BVhmot", fullName: "BVhmot motor coach", manufacturer: "Ganz-MÁVAG", category: TrainCategory.RAILCAR, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 80, yearIntroduced: 1975, features: ["Heating coach"], operationalNotes: "Motor coach with heating capability" },
  "0434": { uicCode: "0434", name: "BVmot", fullName: "BVmot motor coach", manufacturer: "Ganz-MÁVAG", category: TrainCategory.RAILCAR, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 80, yearIntroduced: 1980, features: ["Basic motor coach"], operationalNotes: "Standard motor coach for branch lines" },

  // ===== SPECIAL UNITS =====

  "1416": { uicCode: "1416", name: "Bpmot", fullName: "Metrovagonmas Bpmot electric multiple unit", manufacturer: "Metrovagonmas", category: TrainCategory.EMU, propulsion: PropulsionType.ELECTRIC, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 2, maxSpeed: 80, yearIntroduced: 1985, features: ["Soviet design"], operationalNotes: "Soviet-era EMU, limited use" },
  "1488": { uicCode: "1488", name: "VF", fullName: "Villamos fűtőgép (Electric heating unit)", manufacturer: "Various", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.ELECTRIC, hasAirConditioning: false, comfortLevel: ComfortLevel.BASIC, reliabilityRating: 3, maxSpeed: 80, yearIntroduced: 1970, features: ["Heating provision"], operationalNotes: "Electric heating unit for passenger cars" },
  "2232": { uicCode: "2232", name: "M32", fullName: "M32 narrow gauge locomotive", manufacturer: "Ganz-MÁVAG", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.VINTAGE, reliabilityRating: 3, maxSpeed: 40, yearIntroduced: 1960, features: ["Narrow gauge"], operationalNotes: "Narrow gauge forest railways" },

  // International/leased locomotives
  "6182": { uicCode: "6182", name: "EuroSprinter Akiem", fullName: "Siemens EuroSprinter (Akiem leased)", manufacturer: "Siemens", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.ELECTRIC, hasAirConditioning: true, comfortLevel: ComfortLevel.MODERN, reliabilityRating: 5, maxSpeed: 200, yearIntroduced: 2005, features: ["Leased locomotive", "International services"], operationalNotes: "Leased from Akiem for international services" },
  "0001": { uicCode: "0001", name: "Viking", fullName: "Henschel Viking diesel locomotive", manufacturer: "Henschel", category: TrainCategory.LOCOMOTIVE, propulsion: PropulsionType.DIESEL, hasAirConditioning: false, comfortLevel: ComfortLevel.VINTAGE, reliabilityRating: 2, maxSpeed: 100, yearIntroduced: 1960, features: ["German design"], operationalNotes: "Rare German locomotive, heritage use" }
};

// Helper function to get train type by UIC code
export function getTrainTypeByUIC(uicCode: string): TrainType | undefined {
  return HUNGARIAN_TRAIN_TYPES[uicCode];
}

// Helper function to get all train types by category
export function getTrainTypesByCategory(category: TrainCategory): TrainType[] {
  return Object.values(HUNGARIAN_TRAIN_TYPES).filter(type => type.category === category);
}

// Helper function to get modern trains (with AC)
export function getModernTrains(): TrainType[] {
  return Object.values(HUNGARIAN_TRAIN_TYPES).filter(type => type.hasAirConditioning);
}

// Helper function to search train types
export function searchTrainTypes(query: string): TrainType[] {
  const lowercaseQuery = query.toLowerCase();
  return Object.values(HUNGARIAN_TRAIN_TYPES).filter(type => 
